                ...
                case 'typography2':
                    ...
                    if(isset($typography_stored['face'])) {
                        ...
                        $faces = array('arial'=>'Arial',
                            ...
                            'helvetica'=>'Helvetica',
                            'google_Alice'=>'Alice',
                            'google_Allerta'=>'Allerta',
                            'google_Arvo'=>'Arvo',
                            'google_Antic'=>'Antic',

                            'google_Bangers'=>'Bangers',
                            'google_Bitter'=>'Bitter',

                            'google_Cabin'=>'Cabin',
                            'google_Cardo'=>'Cardo',
                            'google_Carme'=>'Carme',
                            'google_Coda'=>'Coda',
                            'google_Coustard'=>'Coustard',
                            'google_Gruppo'=>'Gruppo',

                            'google_Damion'=>'Damion',
                            'google_Dancing Script'=>'Dancing Script',
                            'google_Droid Sans'=>'Droid Sans',
                            'google_Droid Serif'=>'Droid Serif',

                            'google_EB Garamond'=>'EB Garamond',

                            'google_Fjord One'=>'Fjord One',

                            'google_Inconsolata'=>'Inconsolata',

                            'google_Josefin Sans' => 'Josefin Sans',
                            'google_Josefin Slab'=>'Josefin Slab',

                            'google_Kameron'=>'Kameron',
                            'google_Kreon'=>'Kreon',

                            'google_Lobster'=>'Lobster',
                            'google_League Script'=>'League Script',

                            'google_Mate SC'=>'Mate SC',
                            'google_Mako'=>'Mako',
                            'google_Merriweather'=>'Merriweather',
                            'google_Metrophobic'=>'Metrophobic',
                            'google_Molengo'=>'Molengo',
                            'google_Muli'=>'Muli',

                            'google_Nobile'=>'Nobile',
                            'google_News Cycle'=>'News Cycle',

                            'google_Open Sans'=>'Open Sans',
                            'google_Orbitron'=>'Orbitron',
                            'google_Oswald'=>'Oswald',

                            'google_Pacifico'=>'Pacifico',
                            'google_Poly'=>'Poly',
                            'google_Podkova'=>'Podkova',

                            'google_Quattrocento'=>'Quattrocento',
                            'google_Questrial'=>'Questrial',
                            'google_Quicksand'=>'Quicksand',

                            'google_Raleway'=>'Raleway',

                            'google_Salsa'=>'Salsa',
                            'google_Sunshiney'=>'Sunshiney',
                            'google_Signika Negative'=>'Signika Negative',


                            'google_Tangerine'=>'Tangerine',
                            'google_Terminal Dosis'=>'Terminal Dosis',
                            'google_Tenor Sans'=>'Tenor Sans',

                            'google_Varela Round'=>'Varela Round',

                            'google_Yellowtail'=>'Yellowtail'
                        );
                        foreach ($faces as $i=>$face) {
                            $output .= '<option value="'. $i .'" ' . selected($typography_stored['face'], $i, false) . '>'. $face .'</option>';
                        }
