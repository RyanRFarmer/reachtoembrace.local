...
jQuery(document).ready(function () { //#Begin
    ...
    var contact_elements = '#contactform #fullname, #contactform #email, #contactform #url, #contactform #captcha, #contactform #form_message';
    jQuery(contact_elements).focus(function(){
        var contact_info = jQuery(this).val();
        if(jQuery.trim(contact_info) == 'Full Name:' ||
            jQuery.trim(contact_info) == 'Email:' ||
            jQuery.trim(contact_info) == 'Website URL:' ||
            jQuery.trim(contact_info) == 'Above Code:' ||
            jQuery.trim(contact_info) == 'Comment:') {
            jQuery(this).val('');
        }
    });
    jQuery(contact_elements).blur(function(){
        var contact_info = jQuery(this).val();
        if(jQuery.trim(contact_info) == '') {
            switch(jQuery(this).attr('id')){
                ...
                case 'email':
                    ...
                    break;
                case 'url':
                    jQuery(this).val('Website URL:');
                    break;
                case 'captcha':
                    jQuery(this).val('Above Code:');
                    break;
                case 'form_message':
