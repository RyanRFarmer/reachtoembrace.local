        ...
        <div id="entries">
                        ...
                        <ul>
                            ...
                            if (count($term_array) > 0) {
                                ...
                                foreach ($term_array as $term_slug => $term_name) {
                                    ?>
                                    <li><a href="#" data-filter=".<?php echo $term_slug;?>"
                                           title=""><?php echo $term_name;?></a>
                                        <?php $n++;?></li>
                                    <?php
                                }
                            }?>
            ...
            <?php
                    ...
                    while ($wp_query->have_posts()) : $wp_query->the_post();
                        ...
                        $thumb_url = ht_image_resize(500, 810, $image_url);
                        ...
                        <div id="post-<?php the_ID();?>" class="folio-box clearfix <?php echo $filter_list;?>">
                            <div class="frame">
